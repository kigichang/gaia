...
export const SOURCE_LINKS: Record<string, string> = {
  ...
  /**
   * 馬里亞納海溝那一筆。兩個條目分開登記：海溝本身（長度、寬度、成因、歷次測深、
   * 水壓與距地心那組數字）與挑戰者深淵（歷次載人下潛的日期、深度與人名）。
   * ⚠️ 這張卡的重點正是「同一件事有好幾個數字」，所以兩篇都要連得到——海溝那篇的
   * 資訊框寫 11,034 公尺、內文卻說那個值不以為準確，讀者得自己翻得到那一段。
   * 聖母峰的 8,848.86 公尺沿用上面世界之最那一筆已經登記過的珠穆朗瑪峰條目。
   */
  "維基百科 馬里亞納海溝":
    "https://zh.wikipedia.org/zh-tw/%E9%A6%AC%E9%87%8C%E4%BA%9E%E7%B4%8D%E6%B5%B7%E6%BA%9D",
  "維基百科 挑戰者深淵":
    "https://zh.wikipedia.org/zh-tw/%E6%8C%91%E6%88%B0%E8%80%85%E6%B7%B1%E6%B7%B5",
  /**
  ...
  /**
   * 蘇必略湖（2026-09 加進「湖泊」那一層的第四筆）。
   * ⚠️ 三筆來源各自對應卡片上一件追不到別處的事，不要收斂成只連中文維基：
   * 面積／蓄水量／最大深度／滯留時間 191 年採**美國環保署**那張五大湖物理特徵表
   * （五大湖的主管機關，同一張表也給得出密西根湖與休倫湖的面積，卡片裡
   * 117,400 km² 就是那兩欄相加）——⚠️ 中文維基的面積寫 82,414，本站採 82,100，
   * 那是刻意的不是抄錯。
   * ⚠️ 「密西根－休倫湖水文上是同一個湖」中文維基沒有對應條目，只連主條目
   * 追不到，所以另外登記英文維基（比照裏海法律地位公約那一筆的處理）。
   */
  "維基百科 蘇必略湖": "https://zh.wikipedia.org/zh-tw/%E8%98%87%E5%BF%85%E5%88%A9%E5%B0%94%E6%B9%96",
  "美國環境保護署 五大湖物理特徵":
  ...
  /**
   * 「火山大賞」那一層。收錄名單本身出自大屯火山觀測站（TVO，國家地震工程研究中心）
   * 「與火山近距離－世界火山」那一頁，所以第一個標籤連的是那一頁而不是 TVO 首頁
   * ——那份名單是這一層存在的理由，連首頁等於追不到（比照「行政院 國情簡介－土地」
   * 的既有判斷）。
   */
  ...
  /**
   * 黃石那一筆分兩個條目：火山系統本身（三次超級噴發的年代與噴出量、熱點軌跡）
   * 與國家公園（1872 年成立、間歇泉與地熱點的數量）。兩件事在維基百科上就是
   * 兩篇，連一篇追不到另一半。
   */
  "維基百科 黃石火山": "https://zh.wikipedia.org/zh-tw/%E9%BB%84%E7%9F%B3%E7%81%AB%E5%B1%B1",
  "維基百科 黃石國家公園":
    "https://zh.wikipedia.org/zh-tw/%E9%BB%83%E7%9F%B3%E5%9C%8B%E5%AE%B6%E5%85%AC%E5%9C%92",
  /**
   * 皮納圖波那兩份美國地質調查所的 fact sheet。⚠️ 噴發規模、二氧化硫量、全球降溫
   * 幅度與「至少救下 5,000 條人命、2.5 億美元財產」這幾個數字一律以它們為準——
   * 維基百科是次級來源，而那張卡整段的重點就是那個估計值本身。兩份分開登記：
   * 113-97 講那次噴發，115-97 講監測的效益。條目本身沿用上面世界主要山脈那一批
   * 已經登記過的「維基百科 皮納圖博火山」（⚠️ 中文維基的條目名是「皮納圖博」，
   * 本站的圖徵名用臺灣教材慣用的「皮納圖波」，兩種寫法都寫進了 geojson 的 meta）。
   */
  "美國地質調查所 1991 年皮納圖波火山噴發": "https://pubs.usgs.gov/fs/1997/fs113-97/",
  "美國地質調查所 火山監測的效益：皮納圖波的案例": "https://pubs.usgs.gov/fs/1997/fs115-97/",
  "維基百科 塔阿爾火山":
    "https://zh.wikipedia.org/zh-tw/%E5%A1%94%E9%98%BF%E7%88%BE%E7%81%AB%E5%B1%B1",
  /**
   * 雲仙岳那一筆分兩個條目：火山本身（平成新山、1991 年的火山碎屑流）與 1792 年
   * 那場災難（「島原大變肥後迷惑」——眉山崩塌與海嘯，逾一萬五千人罹難）。
   * 那場災難是這張卡真正要講的東西，連到火山條目追不到細節。
   */
  "維基百科 雲仙岳": "https://zh.wikipedia.org/zh-tw/%E9%9B%B2%E4%BB%99%E5%B2%B3",
  "維基百科 島原大變肥後迷惑":
    "https://zh.wikipedia.org/zh-tw/%E5%B3%B6%E5%8E%9F%E5%A4%A7%E8%AE%8A%E8%82%A5%E5%BE%8C%E8%BF%B7%E6%83%91",
  "維基百科 櫻島": "https://zh.wikipedia.org/zh-tw/%E6%AB%BB%E5%B3%B6",
};
