...
export const taiwanTheme: ThemeDefinition = {
  ...
  layers: [
    ...
    },
    {
      ...
      /**
       * 樣式**刻意跟全球主題的緯度參考線、國際換日線一模一樣**（同色、同虛線、同線寬）：
       ...
       *
       * `spacing: 260` 是實測調的：這條線又直又只有一條，緯度參考線那組 320 在全島
       * 視角只放得出 1 個標註，200 以下則會在同一條線上重複印出「海峽中線」。
       *
       * ⚠️ **線寬 2.2 是量出來的，不要照抄全球主題那兩條參考線的 1.2。** 那兩條畫在
