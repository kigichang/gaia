  ...
  layers: [
    ...
    },
    {
      ...
      notes: [
        ...
        "⚠️ 這一層只放**單點**的項目；有範圍的（例如百慕達三角）在同一組的「作者精選・範圍」，兩層的收錄判準相同，分開只是因為一個圖層只能有一種幾何。",
    ...
    },
    {
      ...
      /**
       * ⚠️ **虛線是必要的，不是裝飾。** 這一層畫的是「別人是這樣圈的」——百慕達
       * 三角根本沒有官方界線（美國海軍與海岸防衛隊明講它不在任何官方海圖上）。
       * 實線會讓它看起來像一條真實的界線，那正好是這張卡要拆穿的東西。
      ...
      browse: { groupBy: "category" },
      /**
       * ⚠️ `maxzoom: 8`：三條直線再放大只是三條直線，而這一層畫的是一個**概念**
       * 的範圍。讓它在區域尺度就收掉，避免看起來像一條可以逐段追下去的界線。
       */
      maxzoom: 8,
      description:
        "「作者精選」裡有範圍的項目。第一個是百慕達三角——一個沒有官方界線的「地方」，" +
        "拿來練習怎麼查證一個聽起來很像真的說法。",
      notes: [
        "⚠️ 這一層畫的是「別人是這樣圈的」，不是官方界線。百慕達三角不存在於任何官方海圖上，各家畫法不同，面積從 130 萬到 390 萬平方公里都有——所以畫成虛線，各筆也標了示意。",
