  ...
  layers: [
    ...
    // 暫時不會再出現勾滿變 disabled 的情形，那是下架的連帶結果，不是上限被改過。
    {
      ...
      description:
        ...
        "退役的太空船都往那裡送；六條海峽——直布羅陀、博斯普魯斯、曼德、荷姆茲、麻六甲" +
        "由西往東一路扣住全球的海運航線，最窄的門只有幾百公尺到幾十公里，外加日本小豆島" +
        "的土渕海峽，只有 9.93 公尺寬，而「世界最窄的海峽」這個頭銜不是量出來的、" +
        "是官方登記出來的；還有三個湖——死海、裏海與貝加爾湖，" +
        "各自把「湖」這件事推到一個極端。",
      notes: [
        ...
        "⚠️ 六條海峽在可點清單裡是**由西往東依經度排**的（直布羅陀、博斯普魯斯、曼德、荷姆茲、麻六甲、土渕），那是刻意的：前五條剛好串成從大西洋到東亞的那條海運航線。",
