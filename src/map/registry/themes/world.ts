  ...
  layers: [
    ...
    // 暫時不會再出現勾滿變 disabled 的情形，那是下架的連帶結果，不是上限被改過。
    {
      ...
      description:
        ...
        "要把船抬高 26 公尺、另一條一道船閘都不用；還有三個湖——死海、裏海與貝加爾湖，" +
        "各自把「湖」這件事推到一個極端。",
      notes: [
        ...
        "⚠️ 巴拿馬運河與蘇伊士運河那兩張卡裡各有一段是**有時效**的（引用 IMF PortWatch 的每日通行艘次，統計截到 2026 年 8 月 23 日，已在內文寫明），跟曼德海峽、臺灣海峽同一份資料、同一個更新問題——**要更新就四張卡一起更新**，它們互相引用對方的數字。",
