...
- **作者精選**（`world-picks` 點＋`world-picks-areas` 線）：編者挑的地方，目前是
  ...
  **六條海峽**（直布羅陀、博斯普魯斯、曼德、荷姆茲、麻六甲、土渕）、死海、裏海、
  貝加爾湖、東非大裂谷與百慕達三角。
...
#### 六條海峽是一組，`category` 從「海洋」拆出來了

2026-08 加進直布羅陀、博斯普魯斯、曼德三條之後，這一層的海峽變成六條，於是把它們的
...
⚠️ **geojson 裡六條海峽是由西往東依經度排的**（直布羅陀 −5.5°、博斯普魯斯 29.1°、
曼德 43.3°、荷姆茲 56.4°、麻六甲 103.5°、土渕 134.2°），而 `groupBy` **依序切、不排序**，
所以同一類必須連續——加第七條海峽時要插在經度對的位置，不能往檔案尾巴丟。前五條剛好
串成從大西洋到東亞的那條海運航線，土渕排最後是因為它經度最東，跟「它是異類」正好同向。
