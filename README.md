...
架構已經做好，資料逐步回補中。三個主題共 **31 個圖層**，其中 9 個已有資料，其餘 22 個會顯示成停用的「資料整理中」選項——但仍然寫了說明與資料來源，讓人看得出這張地圖打算長成什麼樣子。

已有資料的圖層：

- **臺灣**：縣市界（21 個）、五大山脈、地形景點、原住民族 16 族、特有種 5 種的 GBIF 觀測點
...
- **五大山脈畫的是走向示意稜線**，不是精確測繪界線：山脈沒有官方界線圖資，走向與端點依維基百科條目與地形圖描繪。
